...
class AkunView extends GetView<AppStateService> {
                    ...
                    Center(
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          leading:
                              const Icon(Icons.mode_edit_outline_outlined, color: AppColor.blue),
                        ...
                        ListTile(
                          onTap: _logoutKonfirmationDialog,
  ...
  void _logoutKonfirmationDialog() {
    Get.defaultDialog(
      title: "Konfirmasi",
      content: Text('keluar dari ${controller.userObs.value?.email}?'),
      confirm: TextButton(
          onPressed: controller.logout,
          child: const Text('Keluar', style: TextStyle(color: AppColor.blue))),
      cancel: TextButton(
          onPressed: ()=>Get.back(),
